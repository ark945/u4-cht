...
*640×400 全美術 2x 重繪的 Ultima IV 標題畫面 — 標題動畫、雙龍、Britannia 地圖完整重現。*
...
> 目前狀態:**640×400 全美術 2x + CJK 1-cell 已上畫面** —— 標題 / 選單 / 角色創建 / intro 故事 / NPC 對話 / 系統訊息 / vendor 商店全部中文,實機 headless 截圖驗證。剩餘:vendor 進城實機截圖、跨平台打包。
