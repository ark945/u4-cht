...
| Sega SMS | — | 🔬 格式已逆向(VDP name-table + pattern bank,需模擬器 dump VRAM 取 tile) |
...
3. [兩個時代的美術 F2](#art)
4. [這是什麼](#這是什麼)
5. [一款改寫 RPG 的遊戲 —— Ultima IV 的來歷](#歷史)
6. [為何選 xu4(而非 u4remastered)](#為何選-xu4)
7. [八德 — Avatar 之道的起點](#八德)
8. [遊戲中熱鍵](#hotkeys)
9. [快速開始](#快速開始)
10. [目前進度](#目前進度)
11. [技術架構](#技術架構)
